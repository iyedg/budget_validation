...
def recursive_sum(tree):
    """Recursively calculate the sum of each node's children, and add a gap attribute for
     the difference between the sum of the children's value and the node's value
